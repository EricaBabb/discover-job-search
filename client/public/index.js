(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["IndeedApiClient"] = factory();
	else
		root["IndeedApiClient"] = factory();
})(this, function() {
...
function(module, exports, __webpack_require__) {
	...
	var _jobSearch2 = __webpack_require__(3);
...
function(module, exports, __webpack_require__) {
	...
	function jobSearch(url, publisherId) {
	  var _this = this;
	
	  var endpoint = '/apisearch';
	  _queryStrings2.default.publisher = publisherId;
	  ...
	  this.location = function (location) {
	    _queryStrings2.default.l = location;
	    return _this;
	  };
	
	  // default sort is 'relevance'
	  this.sort = function (sort) {
	    _queryStrings2.default.sort = sort;
	    return _this;
	  };
	
	  // default radius is 25, the max is 150
	  this.radius = function (radius) {
	    _queryStrings2.default.radius = radius;
	    return _this;
	  },
	  // default is `all`
	  this.siteType = function (st) {
	    _queryStrings2.default.st = st;
	    return _this;
	  },
	  // default is 'all'
	  this.jobType = function (jt) {
	    _queryStrings2.default.jt = jt;
	    return _this;
	  },
	  // default is 0
	  this.start = function (start) {
	    _queryStrings2.default.start = start;
	    return _this;
	  },
	  // default is 10, the max is 25
	  this.limit = function (limit) {
	    _queryStrings2.default.limit = limit;
	    return _this;
	  }, this.daysBack = function (days) {
	    _queryStrings2.default.fromage = days;
	    return _this;
	  },
	  // default is 0, which is off
	  this.highlight = function (num) {
	    _queryStrings2.default.highlight = num;
	    return _this;
	  },
	  // default is 1, which turns off duplicate postings
	  this.filter = function (num) {
	    _queryStrings2.default.filter = num;
	    return _this;
	  },
	  // default is 0, which doesn't return lat long info with each response
	  this.latlong = function (num) {
	    _queryStrings2.default.latlong = num;
	    return _this;
	  },
	  // default is 'us'
	  this.country = function (country) {
	    _queryStrings2.default.co = country;
	    return _this;
	  }, this.channel = function (channel) {
	    _queryStrings2.default.chnl = channel;
	    return _this;
	  },
	  // this is a required filed
	  this.userIp = function (userIp) {
	    _queryStrings2.default.userip = userIp;
	    return _this;
	  },
	  // this is a required field
	  this.userAgent = function (userAgent) {
	    _queryStrings2.default.useragent = userAgent;
	    return _this;
	  }, this.done = function () {
	    if (_queryStrings2.default.userip && _queryStrings2.default.useragent) {
	      var params = _queryString2.default.stringify(_queryStrings2.default);
	      var fullURL = '' + url + endpoint + '?' + params;
	
	      return (0, _http.getData)(fullURL).then(function (response) {
	        return response;
	      });
	    } else {
